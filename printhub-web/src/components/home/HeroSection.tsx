...
import { Upload, Clock, Shield, Printer } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 text-center">
            ...
            <div>
              ...
              <p className="text-sm font-medium">Quick Turnaround</p>
              <p className="text-xs text-white/60">Same day printing</p>
            </div>
          </div>
        </div>
      </div>
